...
* [Machine Learning with Titanic](/portfolio/post/Titanic_Survival_MachineLearning/) - a survival model using summary statistics and k-nearest-neighbors (knn) to predict the survical of passengers on the RMS Titanic and viability of the model.
