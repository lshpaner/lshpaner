...
$$\text{Price (in USD)}=\beta_0 +\beta_1\text{Year_Built}+\beta_2\text{Bedrooms}+\beta_3\text{HOA(Y|N)}+\beta_4\text{Region_in_LA}+\beta_5\text{Housing_Type}+\epsilon \ \ \ \ \ \ \ \ \ \ \ \ \ \   (1)$$ 
...
ht<span>tps://www.opendoor.com/w/blog/why-days-on-market-matter </ol>
