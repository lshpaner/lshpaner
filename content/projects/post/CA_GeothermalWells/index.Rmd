...
The following visualization shows county by county numbers (quantity) of Geothermal Wells in the State of CA. This data was sourced independently from the [CALGem ArcGIS Hub open data](https://hub.arcgis.com/datasets/d639eb012fe142c89ea8ac779a665ca5_1/data?geometry=-119.036%2C32.448%2C-114.284%2C33.255) and linked directly to Tableau using [Javascript](https://lshpaner.rbind.io/datasets/ca_geothermal_data/cageothermalwells.js) and html to produce this [web data connector](https://lshpaner.rbind.io/datasets/ca_geothermal_data/cageothermalwells.html) whose button is clickable within the Tableau environment.
