...
$\small{H_\alpha:}$ (alternative hypothesis): the number of students enrolled in 2020 will fall below 30,000 ${\large\Longrightarrow{\hspace{2mm}}}$ $\small {H_a: \mu < 30,000}$
