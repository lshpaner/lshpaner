...
Finally, we proceed to plug in the parameters for the quadratic program by placing thhem into the QP data frame, thereby allowing us to run the solution and ensuing ROI as follows:
