...
The following visualization was sourced from the Army Corps. of Engineers' list of military installations in the contiguous United States and remote territories from the [ArcGIS open data hub portal](https://geospatial-usace.opendata.arcgis.com/datasets/85e5114c86fc4e5ba2d1e29ca213b834_0). Though this list is not necessarily meant to be one that is exhaustive or comprehensive in size and scope, it does yield results that were ["reported in the 2015 Base Structure Report (BSR)."](https://www.acq.osd.mil/eie/Downloads/BSI/Base%20Structure%20Report%20FY15.pdf)


This geospatial dataset's parameters were parsed from this [.geojson](https://opendata.arcgis.com/datasets/85e5114c86fc4e5ba2d1e29ca213b834_0.geojson) format and linked directly to Tableau using [Javascript](https://lshpaner.rbind.io/datasets/US_Army_Corpsof_Engineers/DOD_Sites/ACE_DOD_Sites.js) and html to produce this [web data connector](https://lshpaner.rbind.io/datasets/US_Army_Corps_of_Engineers/DOD_Sites/ACE_DOD_Sites.html) whose button is clickable within the Tableau environment.
